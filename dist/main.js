...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_loadScores_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/loadScores.js */ \"./src/modules/loadScores.js\");\n/* harmony import */ var _modules_saveScores_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/saveScores.js */ \"./src/modules/saveScores.js\");\n\n\n\n\n(0,_modules_loadScores_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n\nconst formSaveScore = document.querySelector('#add-score-form');\nconst btnRefresh = document.querySelector('#btn-refresh');\n\nformSaveScore.addEventListener('submit', (event) => {\n  event.preventDefault();\n  const gameId = localStorage.getItem('game-id');\n  const { name, score } = formSaveScore;\n  (0,_modules_saveScores_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(name.value, Number(score.value), gameId);\n  formSaveScore.reset();\n});\n\nbtnRefresh.addEventListener('click', () => {\n  document.querySelector('#refreshing-message').innerHTML = 'Data scores are reloaded!';\n  setTimeout(() => {\n    document.querySelector('#refreshing-message').innerHTML = '';\n  }, 2000);\n  (0,_modules_loadScores_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n});\n\n\n//# sourceURL=webpack://leaderboard-api/./src/index.js?");
